...
function thim_get_all_plugins_require( $plugins ) {
	$plugins = array(
        ...
        array(
            ...
            //'source'      => 'https://plugins.thimpress.com/downloads/eduma-plugins/learnpress-assignments.zip',
            'premium' => true,
            'required'    => false,
            'version'     => '3.0',
            'description' => 'Adding Course Assignments for LearnPress.',
            'add-on'      => true,
        ),
        ...
        array(
            ...
            //'source'      => 'https://plugins.thimpress.com/downloads/eduma-plugins/learnpress-announcements.zip',
            'premium' => true,
            'required'    => false,
            'version'     => '3.0.1',
            'description' => 'Adding Course Announcements for LearnPress.',
            'add-on'      => true,
        ),
